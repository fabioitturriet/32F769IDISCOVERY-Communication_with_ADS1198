...
void ADS_Init(){
	...
	/*================================ECG 12 DERIVAÇÕES Begin================================*/
		...
		//Work settings
		ADS_WREG(CONFIG1,0b00000100); //00000101 fMOD/512 250SPS
		HAL_Delay(100);
		ADS_WREG(CONFIG2,0b00100000);   //00110000 fonte de sinal de teste interno
		HAL_Delay(100);
	...
	//	HAL_Delay(10);
		...
		HAL_Delay(10);
	*/
		ADS_WREG(CONFIG4,0b00000000);  //00000010 modo continuo, WCT para RLD off, Lead-off comparador on
		//ADS_WREG(CONFIG4,0b00001010);//Single-shot mode
		HAL_Delay(10);

		ADS_WREG(0x18,0b00001011);  //WTC1, 00001010 Channel 2 positive input connected to WCTA amplifier
		HAL_Delay(10);

		ADS_WREG(0x19,0b11010100); //WCT2, 11100011 100 = Channel 3 positive input connected to WCTB amplifier e
...
//		HAL_Delay(100);
//
//			ADS_WREG(CH1SET,0b00010101);
//			HAL_Delay(10);
//			ADS_WREG(CH2SET,0b00010101);
//			HAL_Delay(10);
//			ADS_WREG(CH3SET,0b00010101);
//			HAL_Delay(10);
//			ADS_WREG(CH4SET,0b00010101);
//			HAL_Delay(10);
//			ADS_WREG(CH5SET,0b00010101);
//			HAL_Delay(10);
//			ADS_WREG(CH6SET,0b00010101);
//			HAL_Delay(10);
//			ADS_WREG(CH7SET,0b00010101);
//			HAL_Delay(10);
//			ADS_WREG(CH8SET,0b00010101);
//			HAL_Delay(10);
//
//			ADS_RREGS(0,17);
//			HAL_Delay(1000);
...
//
//	//Work settings
//	ADS_WREG(CONFIG1,0b00000100); //00000100 fMOD/256 500SPS
//	HAL_Delay(100);
...
//	HAL_Delay(10);
//
//	ADS_WREG(CH1SET,0b00010000);  //00010000
//	HAL_Delay(10);
//	ADS_WREG(CH2SET,0b01100000);  //00010100 medir DC
//	HAL_Delay(10);
//	ADS_WREG(CH3SET,0b00010000);  //10010000 canal desligado, entrada normal
//	HAL_Delay(10);
//	ADS_WREG(CH4SET,0b00010000);
//	HAL_Delay(10);
//	ADS_WREG(CH5SET,0b00010000);  //01010101
//	HAL_Delay(10);
//	ADS_WREG(CH6SET,0b00010000);
//	HAL_Delay(10);
//	ADS_WREG(CH7SET,0b00010000);  //01100101
//	HAL_Delay(10);
//	ADS_WREG(CH8SET,0b00010000);  //00010000
//	HAL_Delay(10);
//
//	ADS_WREG(BIAS_SENSP,0b00000110);
//	HAL_Delay(10);
//	ADS_WREG(BIAS_SENSN,0b00000100);
//	HAL_Delay(10);
//	/*
//	ADS_WREG(LOFF_SENSP,0xFF);
//	HAL_Delay(10);
